...
/*==========================Algorithm description, fopenmp===========================
In this progra, the loop scheduling use dynamic scheduling. 

#pragma omp parallel private(row, multiplier, col) num_threads(procs) part 
describes the private variables.

#pragma omp for schedule(dynamic) defines  the dynamic scheduling
